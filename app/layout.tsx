...
description:
  'Fallen Souls es un videojuego indie roguelike FPS con estética dark fantasy low poly PS2. Sumergete en un mundo gótico lleno de almas perdidas.',
keywords: [
  'videojuego',
  'indie game',
  'FPS',
  ...
  openGraph: {
    ...
    description:
      'Videojuego indie de accion roguelike con estética PS2 gótica. Combate rápido, poderes especiales y permadeath.',
    images: [
      {
